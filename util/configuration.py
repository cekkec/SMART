...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--data_pick', help='all(D17+YT) or d17(only DAVIS2017) or yv(Only YouTube)')
        ...
        parser.add_argument('--tao_root', help='TAOVOS data root', default='../TAO')
        
        # SMART parameters
        parser.add_argument('--set_loss', help='', type=str, default='CE')
        parser.add_argument('--dice_rate', help='Ratio of Reliable loss', type=float)
        parser.add_argument('--inter_rate', help='Ratio of Intersection loss', type=float)
        parser.add_argument('--uni_rate', help='Ratio of Union loss', type=float)
        parser.add_argument('--dice_score', help='', type=float)
